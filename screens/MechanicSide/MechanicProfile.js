...
const MechanicProfile = () => {
  ...
  const loadProfileData = async () => {
    setLoading(true);
    try {
      const docRef = doc(db, 'mechanics', currentUser.uid);
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.timeContainer}>
            <TextInput
              ...
              placeholder="From"
              style={[styles.input, styles.timeInput, errors.workingHoursFrom && styles.inputError]}
            />
            <TextInput
              value={workingHoursTo}
              onChangeText={setWorkingHoursTo}
              placeholder="To"
              style={[styles.input, styles.timeInput, errors.workingHoursTo && styles.inputError]}
            />
          </View>
          {errors.workingHoursFrom && (
            <Text style={styles.errorText}>{errors.workingHoursFrom}</Text>
          )}
          {errors.workingHoursTo && (
            <Text style={styles.errorText}>{errors.workingHoursTo}</Text>
          )}
